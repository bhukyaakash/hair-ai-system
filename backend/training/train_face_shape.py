"""Train Face Shape Classifier Model"""
...
from ..app.ml.preprocessing.image_processing import ImagePreprocessor
...
# Data paths
DATA_DIR = "datasets/face_shapes"
TRAIN_LABELS = "datasets/face_shapes/train_labels.csv"
...
def train_face_shape_model():
    ...
    model = FaceShapeClassifier()
    logger.info(f"Model summary:")
    model.model.summary()
    
    # Get callbacks
    callbacks = get_callbacks("face_shape")
    ...
    with open(f"{MODEL_SAVE_PATH}/face_shape_metrics.json", 'w') as f:
